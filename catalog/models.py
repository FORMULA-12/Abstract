...
class Books(models.Model):
    ...
    picture = models.ImageField(upload_to=path_and_rename, blank=True, verbose_name='Изображение')
    ...
    cover = models.CharField(null=False, max_length=5, choices=COVER, default='SOFT', verbose_name='Переплет')
